...
public class Administracao extends JFrame {
   ...
   private void criarElementos(){
      ...
      removerVoo = GUI.botaoAzul(new JButton(bundle.getString("Administracao.botao.removerVoo")));
      removerVoo.setIcon(GUI.icone("remover"));
      editarVoo = GUI.botaoAzul(new JButton(bundle.getString("Administracao.botao.editarVoo")));
      editarVoo.setIcon(GUI.icone("editar"));
      
      cadastrarVoo.addActionListener(
            new ActionListener() {
      ...
      consultarVoo.addActionListener(
            new ActionListener() {
      ...
      removerAeronave = GUI.botaoAzul(new JButton(bundle.getString("Administracao.botao.removerAeronave"))); 
      removerAeronave.setIcon(GUI.icone("remover"));
      editarAeronave = GUI.botaoAzul(new JButton(bundle.getString("Administracao.botao.editarAeronave")));
      editarAeronave.setIcon(GUI.icone("editar"));
    
      cadastrarAeronave.addActionListener(
            new ActionListener() {
      ...
      consultarAeronave.addActionListener(
            new ActionListener() {
      ...
      removerAeronave.addActionListener(
            new ActionListener() {
      ...
      editarAeronave.addActionListener(
            new ActionListener() {
