...
public class EditAeronave extends JFrame {
   ...
   private void criarElementos(){
      ...
      botaoOK = GUI.botaoVerde(new JButton(bundle.getString("EditAeronave.botao.botaoOK")));
      botaoOK.setIcon(GUI.icone("ok"));
      botaoCancel = GUI.botaoVermelho(new JButton(bundle.getString("EditAeronave.botao.botaoCancel")));
